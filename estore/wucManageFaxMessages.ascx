<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucManageFaxMessages.ascx.cs" Inherits="CCEstore.wucManageFaxMessages" %>

<table width="100%" >
<tr>
    <td colspan="4" class="heading"> 
        <asp:Label ID="Label1" runat="server" Text="Manage Fax Message" 
...
<tr>
    <td colspan="2" width="100px" class="fontnormal" >
        <asp:Label ID="lblExtensionDID" runat="server" Text="Extension" 
            meta:resourcekey="lblExtensionDIDResource1" ></asp:Label>
    </td>
    <td>
        <WebCtlIpsmarx:RadComboBox ID="ddlExtensionDID" runat="server" 
            MaxHeight="150px" Width="250px" meta:resourcekey="ddlExtensionsResource1">
...
<tr id="trmessagetype" runat="server">
    <td colspan="2" width="100px" class="fontnormal" >
        <asp:Label ID="Label3" runat="server" Text="Fax Type" 
            ...
            <MasterTableView>
                <Columns>
                    ...
                    <WebCtlIpsmarx:GridTemplateColumn
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lbDownload" Text="Download" AutoPostBack="True" runat="server"
                            CommandName="Download" meta:resourcekey="lbDownloadResource1"
                              />
                        </ItemTemplate>
                    </WebCtlIpsmarx:GridTemplateColumn>
                </Columns>
