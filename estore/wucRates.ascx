<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucRates.ascx.cs" Inherits="CCEstore.wucRates" %>
        ...
        <tr>
            <td align="left">
                <table id="Table9" height="20" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td>
                            <asp:Label ID="lblError" runat="server" ForeColor="Red" Font-Bold="True" Font-Italic="True" meta:resourcekey="lblErrorResource1"></asp:Label></td>
                    </tr>
                </table>
                            ...
                            <asp:Button ID="btnGo" runat="server" CssClass="Button" Text="Go" OnClick="btnGo_Click"
                                ...
                                <tr>
                                    ...
                                    <td class="fontnormal">
                                        ...
                                        <asp:CheckBox ID="chkExact" runat="server" EnableViewState="False" meta:resourcekey="chkExactResource1" /><asp:Label ID="Label6" runat="server" Text="Exact" meta:resourcekey="Label6Resource1"></asp:Label>
                                    </td>
                                    <td >
                                    </td>
                                    <td style="vertical-align:text-bottom" class="fontnormal">
                                        ...
                                        <WebCtlIpsmarx:RadComboBox id="ddlPageSize" Runat="server" OnSelectedIndexChanged="ddlPageSize_SelectedIndexChanged"
                                            AutoPostBack="True" Width="50px" meta:resourcekey="ddlPageSizeResource1">
                                            <collapseanimation duration="200" type="OutQuint"></collapseanimation>
                                        </WebCtlIpsmarx:RadComboBox>
                                    </td>
                                </tr>
