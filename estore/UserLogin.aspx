<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="CCEstore.UserLogin" %>
																		...
																		<table cellSpacing="0" cellPadding="3" width="100%" border="0">
																			...
																			<tr>
																				<td class="font" style="HEIGHT: 23px">
                                                                                    <asp:Label ID="Label3" runat="server" Text="Username" meta:resourcekey="Label3Resource1"></asp:Label></td>
																			...
																			<tr>
																				<td>&nbsp;</td>
																				<td>
                                                                                    <asp:CheckBox ID="chkRemember" runat="server" Font-Bold="False" Font-Size="9pt" 
                                                                                        ForeColor="#6F8CAE" TabIndex="4" />
