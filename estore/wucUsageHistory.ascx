<%@ Control Language="C#" AutoEventWireup="true" Codebehind="wucUsageHistory.ascx.cs"
    Inherits="CCEstore.wucUsageHistory" %>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <WebCtlIpsmarx:RadGrid ID="rgDetails" runat="server" Skin="Sunset" AllowPaging="True"
                                    ...
                                    OnItemDataBound="rgDetails_ItemDataBound" Width="725px" meta:resourcekey="rgDetailsResource1">
