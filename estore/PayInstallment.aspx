<%@ Page Title="" Language="C#" MasterPageFile="~/MainService.Master" AutoEventWireup="true"
    CodeBehind="PayInstallment.aspx.cs" Inherits="CCEstore.PayInstallment" %>
                    ...
                    <table style="table-layout: fixed;">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td colspan="2" class="heading">
                                            <asp:Label ID="lblTitle" runat="server" Text="Pay Installment" 
                                    ...
                                    <tr>
                                        ...
                                        <td width="70%">
                                            <asp:Label ID="lblAmount" runat="server" CssClass="bg_blue" Font-Bold="False" 
                        ...
                        <tr id="trTerm" runat="server" visible="true">
                            <td id="Td1" align="center" runat="server">
                                <br />
                                <iframe width="85%" src="./Terms.aspx" scrolling="auto"></iframe>
                                <br />
