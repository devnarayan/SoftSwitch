<%@ Control Language="C#" AutoEventWireup="true" Codebehind="HomeServices.ascx.cs"
    Inherits="CCEstore.HomeServices" %>
                    ...
                    <td>
                        ...
                        <table width="100%"   >
                            <tr>
                                ...
                                <td>
                                    <WebCtlIpsmarx:RadComboBox ID="ddlPayment" runat="server" MarkFirstMatch ="true" meta:resourcekey="ddlPaymentResource1" >
