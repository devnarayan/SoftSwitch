<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucSIPTrunking.ascx.cs" Inherits="CCEstore.wucSIPTrunking" %>
                                                                                    ...
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <asp:Label ID="lblPriceCaption" runat="server" Text="Price:" 
                                                                                                    ...
                                                                                                    visible='<%# decimal.Parse(DataBinder.Eval(Container.DataItem, "PriceOnline").ToString())>0 %>' meta:resourcekey="lblPriceCaptionResource1"
                                                                                             />
                                                                                    <asp:Label ID="Label6" runat="server" Text='<%# PayCentral.Library.General.GetCurrencySymbol() + DataBinder.Eval(Container.DataItem, "PriceOnline").ToString() %>'
                                                                                        ...
                                                                                        <tr id="trYouSave" runat="server" visible='<%# decimal.Parse(DataBinder.Eval(Container.DataItem, "YouSave").ToString())>0 %>'>
                                                                                            <td class="pricing_discount_desc" runat="server">
                                                                                                ...
                                                                                                <asp:Label runat="server" ID="lblYouSave" 
                                                                                                    Text='<%# PayCentral.Library.General.GetCurrencySymbol() + DataBinder.Eval(Container.DataItem, "YouSave").ToString() %>' ></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr id="trFinalPrice" runat="server" visible='<%# decimal.Parse(DataBinder.Eval(Container.DataItem, "YouSave").ToString())>0 %>'>
                                                                                            <td class="pricing_sale_desc" runat="server">
                                                                                                ...
                                                                                                <asp:Label runat="server" ID="lblFinalPrice" 
                                                                                                    Text='<%# PayCentral.Library.General.GetCurrencySymbol() + DataBinder.Eval(Container.DataItem, "FinalPrice").ToString() %>' ></asp:Label>
                                                                                                
                                                                                                <asp:Label runat="server" ID="lblPromotionID" 
                                                                                                    Text = '<%# DataBinder.Eval(Container.DataItem, "PromotionID").ToString() %>' 
