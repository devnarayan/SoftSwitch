                ...
                <td class="main" valign="top">
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tbody>
                            <tr>
                                <td class="bg_line">
                                    <img height="1" src="images/pix.gif" width="1" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                        <tbody>
                                            <tr>
                                                <td class="submenu_on" width="17">
                                                    <img height="17" alt="1" hspace="2" src="images/menu/1.gif" width="17" /></td>
                                                <td class="submenu_on">
                                                    <asp:Label ID="Label1" runat="server" Text="Choose Plan"></asp:Label></td>
                                                <td class="submenu_on" width="11">
                                                </td>
                                                <td class="submenu_on" width="17">
                                                    <div align="left">
                                                        <img height="17" alt="2" src="images/menu/2.gif" width="17" /></div>
                                                </td>
                                                <td class="submenu_on">
                                                    <asp:Label ID="Label2" runat="server" Text="Select Number"></asp:Label></td>
                                                <td class="submenu_on">
                                                </td>
                                                <td class="submenu_on" width="17">
                                                    <img height="17" alt="3" src="images/menu/3.gif" width="17" /></td>
                                                <td class="submenu_on">
                                                    <asp:Label ID="Label3" runat="server" Text="Choose Hardware"></asp:Label></td>
                                                <td class="submenu_on">
                                                </td>
                                                <td class="submenu_on">
                                                    <img height="17" src="images/menu/4.gif" width="17" /></td>
                                                <td class="submenu_on">
                                                    <asp:Label ID="Label4" runat="server" Text="Account Info"></asp:Label></td>
                                                <td class="submenu_on">
                                                </td>
                                                <td class="submenu_on">
                                                    <img height="17" alt="5" src="images/menu/5.gif" width="17" /></td>
                                                <td class="submenu_on">
                                                    <asp:Label ID="Label5" runat="server" Text="911 Activation"></asp:Label></td>
                                                <td class="submenu_on" width="11">
                                                    <table height="100%" cellspacing="0" cellpadding="0" width="100%" border="0">
                                                        <tbody>
                                                            <tr>
                                                                <td height="10">
                                                                    <img height="10" src="images/m1.gif" width="11" /></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td height="10">
                                                                    <img height="10" src="images/m2.gif" width="11" /></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                <td class="submenu">
                                                    <img height="17" alt="6" src="images/menu/6.gif" width="17" /></td>
                                                <td class="submenu">
                                                    <asp:Label ID="Label6" runat="server" Text="Billing &amp; Shipping"></asp:Label></td>
                                                <td class="submenu">
                                                </td>
                                                <td class="submenu">
                                                    <img height="17" alt="7" src="images/menu/7.gif" width="17" /></td>
                                                <td class="submenu">
                                                    <asp:Label ID="Label7" runat="server" Text="Order Summary"></asp:Label></td>
                                                <td class="submenu">
                                                </td>
                                            </tr>
                                        </tbody>
                                                                    ...
                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="bg_grey">
                                                                                    <asp:TextBox ID="txtStreetSuffix" runat="server"></asp:TextBox></td>
                                                                                <td class="bg_grey">
                                                                                    <div align="right">
