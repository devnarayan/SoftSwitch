<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.master" AutoEventWireup="true" CodeFile="AddContent.aspx.cs" Inherits="Admin_AddContent" %>
            ...
            <div class="container-fluid container-maverix">
                ...
                <select class="form-control" data-ng-model="WebPageID" data-ng-change="ChangeWebPage()">
                    <option data-ng-repeat="wp in WebPageList" value="{{wp.WebPageID}}">{{wp.PageName}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-ng-model="EnContent"  class="form-control" id="EnContent" />
                            </div>
                ...
                <a data-wysihtml5-command="insertSpeech">speech</a>
                        ...
                        <select data-wysihtml5-dialog-field="className">
                            ...
                            <input type="button" class="btn btn-primary" data-ng-click="SaveNewContent()" value="Submit" />
                        </div>
