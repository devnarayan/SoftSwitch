...
/// <summary>
/// Summary description for PDTHolder
/// </summary>
public class PDTHolder
{
    ...
    public string AddressStreat { get; set; }
    public string PaymentDate { get; set; }
    public string AddressContryCode { get; set; }
            ...
            for (i = 1; i < StringArray.Length - 1; i++)
            {
                ...
                switch (sKey)
                {
                    case "mc_gross":
                        ...
                        break;
                    case "quantity":
                        ph.Quantity = Convert.ToInt32(sValue);
                        break;
                    ...
                    case "first_name":
                        ...
                        break;
                    case "address_street":
                        ph.AddressStreat = Convert.ToString(sValue);
                        break;
                    case "mc_fee":
                        ph.PaymentFee = Convert.ToDouble(sValue);
                        break;
                    case "payment_date":
                        ph.PaymentDate = Convert.ToString(sValue);
                        break;
                    case "business":
                    ...
                    case "address_country":
                        ph.AddressCountry = Convert.ToString(sValue).Replace('+', ' '); // + Remove
                        break;

                    case "address_city":
                        ph.AddressCity = Convert.ToString(sValue).Replace('+', ' ');
                        break;
                    ...
                    case "address_country_code":
                        ph.AddressContryCode = Convert.ToString(sValue);
                        break;
                    ...
                    case "address_name":
                        ph.AddressName = Convert.ToString(sValue).Replace('+', ' '); // + remove;
                        break;
                    ...
                    case "item_name":
                        ph.ItemName = Convert.ToString(sValue).Replace('+', ' ');
                        break;
                    ...
                    case "subscr_id":
                        ...
                        break;
                    case "payment_gross":
                        ph.PaymentGross = Convert.ToDouble(sValue);
                        break;
                }
            }
