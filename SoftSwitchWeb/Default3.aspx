<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/WebsiteMaster.Master" AutoEventWireup="true" CodeFile="Default3.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content3" ContentPlaceHolderID="title" Runat="Server">Home Page
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div data-ng-controller="HeaderFooterController">
        <div id="home">
                            ...
                            <div class="camera_wrap camera_white_skin" id="camera_wrap_1">
                                <div data-thumb="" data-src="images/slides/blank.gif">
                                    <div class="img-responsive camera_caption fadeFromBottom">
                                        <h2><div  data-ng-bind-html="ContentList[1].LangContent"></div></h2>
                                    </div>
                                </div>
                                <div data-thumb="" data-src="images/slides/blank.gif">
                                    <div class="img-responsive camera_caption fadeFromBottom">
                                        <h2><div  data-ng-bind-html="ContentList[2].LangContent"></div></h2>
                                    </div>
                                </div>
                                <div data-thumb="" data-src="images/slides/blank.gif">
                                    <div class="img-responsive camera_caption fadeFromBottom">
                                        <h2><div  data-ng-bind-html="ContentList[3].LangContent"></div></h2>
                                    </div>
                                </div>
                            </div>
                            <!-- #camera_wrap_1 -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 project">
                        <h3 id="counter">0</h3>
                        <h4><div  data-ng-bind-html="ContentList[4].LangContent"></div></h4>
                        <p><div  data-ng-bind-html="ContentList[5].LangContent"></div></p>
                    </div>
                    <div class="col-md-4 project">
                        <h3 id="counter1">0</h3>
                        <h4><div  data-ng-bind-html="ContentList[4].LangContent"></div></h4>
                    ...
                    <div class="col-md-4 project">
                        ...
                        <h4 style="margin-left: 20px;"><div  data-ng-bind-html="ContentList[4].LangContent"></div></h4>
                        <p><div  data-ng-bind-html="ContentList[5].LangContent"></div></p>
                    </div>
                </div>
            </div>
    ...
    <div data-ng-controller="ContentController" data-ng-init="GetContentListByID()">
        <input type="hidden" id="hdnfld" value="4" />
                ...
                <div class="container">
                    <div class="row Fresh">
                        <div class="col-md-4 Des">
                            ...
                            <h4><div  data-ng-bind-html="ContentList[2].LangContent"></div></h4>
                            <p><div  data-ng-bind-html="ContentList[1].LangContent"></div></p>
                        </div>
                        <div class="col-md-4 Ver">
                            <i class="fa fa-cog"></i>
                            <h4><div  data-ng-bind-html="ContentList[3].LangContent"></div></h4>
                            <p><div  data-ng-bind-html="ContentList[4].LangContent"></div></p>
                        </div>
                        <div class="col-md-4 Fully">
                            <i class="fa fa-tablet"></i>
                            <h4><div  data-ng-bind-html="ContentList[5].LangContent"></div></h4>
                            <p><div  data-ng-bind-html="ContentList[6].LangContent"></div></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row team">
                    <div class="col-md-4 b1">
                        ...
                        <p>
                            ...
                            <br />
                            quisque tempus ac eget diam et laoreet phasellus ut nisi id leo molestie. adipiscing vitae vel quam proin eget mauris eget.
                        </p>
                        <ul>
                ...
                <div class="row">
                    <div class="col-md-3 bar">
                        ...
                        <div class="textP">
                            <h3>WordPress</h3>
                            <p>
                                Nulla consectetur ornare nibh, a auctor
                                <br />
                                mauris scelerisque eu proin nec urna quis.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-3 bar">
